...
public class highlight
{
  ...
  public boolean render(Spannable mText, int startOffset, int endOffset)
  {
	...
	int[] ret = jni_parse(text,File.separator + lang[1]);
  ...
  {
	String langfile =Environment.getExternalStorageDirectory().getPath()+"/.920TextEditor/lang.conf";
	Log.e("langfile",langfile);
	...
	try
	{
	  ...
	  Collections.sort(nameTab, new Comparator<String[]>() {
		  ...
		  {
			return object1[0].compareToIgnoreCase(object2[1]);
		  }
		});
	}catch (Exception e)
	{
