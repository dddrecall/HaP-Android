...
public class FilePasteFile extends ListActivity {
	...
	private void viewFiles(String filePath) {
		ArrayList<FileInfo> tmp = FileActivityHelper.getFiles(FilePasteFile.this, filePath);
		if (tmp != null) {
			// 清空数据
			_files.clear();
			_files.addAll(tmp);
	...
	private Button.OnClickListener fun_CreateDir = new Button.OnClickListener() {
		public void onClick(View v) {
			FileActivityHelper.createDir(FilePasteFile.this, _currentPath, createDirHandler);
		}
	};
	...
	private Button.OnClickListener fun_Paste = new Button.OnClickListener() {
		public void onClick(View v) {
			...
			progressDialog = ProgressDialog.show(FilePasteFile.this, "", "Please wait...", true, false);
