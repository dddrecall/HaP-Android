...
public class Utils {
  ...
  public final static String TAG = "HaP";
  ...
  public final static String DEFAULT_IPTABLES = "/data/data/com.HaP.Byml/iptables";
  ...
  public static String root_shell = null;
  ...
  public static final class ScriptRunner extends Thread {
	...
	public SuperUser.putline pl=null;
    ...
    public void run() {
      ...
      try {
        ...
        while (stdout.available() > 0) {
		  ...
		  rr=new String(buf, 0, read);
          result.append(rr); 
		  Log.e(TAG+"_result",rr);
		  if(pl!=null)
			pl.rline(rr);
        }
